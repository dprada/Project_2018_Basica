\documentclass[11pt,letterpaper,titlepage]{article} %report,article?
\usepackage[letterpaper,lmargin=3.0cm,rmargin=3.0cm,tmargin=2.5cm,bmargin=2.5cm,headheight=14pt]{geometry}
...
El mecanismo \red{de infección y alojamiento en el hospedero} adoptado por EBV
tiene particularidades que lo hacen especialmente exitoso y que explican que sea
uno de los \red{virus} más fre\red{c}uentemente encontrado en humanos \red{
...
en los que puede ``residir'' \tout{y} replicándose con ellos durante toda la
vida \tout{del hospedero} \red{del individuo infectado} sin manifestar ni
desencadenar ninguna patología, de manera asintomática. \tout{Durante esta fase
  de vida del virus, la fase latente,} El ADN viral se conserva como episoma
expresando una cantidad mínima de productos cuya función principal es
desarrollar los mecanismos que aseguran su conservación, transcripción y
replicación. \red{Replicación que se produce} una vez por ciclo celular mediante el
acoplamiento físico del episoma al cromosoma de la célula hospedera en su
metafase. \red{Esta etapa del ciclo de infección del virus es conocida como
  ``fase de latencia''} y en ella se pueden distinguir a su vez varias
\red{sub}fases (0, I, II y III) caracterizadas por la presencia de algunas de
las proteínas virales. Tras \red{el contagio} el virus adopta la fase de
latencia III en la que se expresan los antígenos nucleares EBNA (del inglés
Epstein-Barr Nuclear Antigen): EBNA1, EBNA2, EBNA3A, EBNA3B, EBNA3C y EBNA-LP;
además de las proteínas de membrana LMP1, LMP2a y LMP2b, y varios miRNAs
\red{\cite{Kang2015b}}. En la latencia II, I y 0 únicamente algunas de estas
proteínas se expresan, siendo EBNA1 la única presente en todas las fases. Es por
este motivo que EBNA1 ha atraído \tout{desde tanto} la atención de todo el que
pretende desentr\red{a}ñar el mecanismo molecular que posibilita que EBV
permanezca tanto tiempo de manera silente en el hospedero sin levantar ninguna
alarma antigénica
\red{\cite{Israel2003,Jiang2017,Lima2013a,Daskalogianni2015,Noh2016b,Gianti2016,Kosowicz2017}}. La
importancia clínica de este ciclo latente reside en que los productos expresados
por los genes de EBV tienen capacidades oncogénicas, inflamatorias y autoinmunes
pudiendo transformar la célula hospedera infectada en tumoral \red{\cite{Humme2003,Klein2015}}. \tout{Sin
embargo,} \red{Desafortunadamente} en la actualidad no existen fármacos con potencial inhibidor antiviral
para EBV latente \red{\cite{Kempkes2015}}.
...
BZLF1 \tout{(tambi\'en conocida como prote\'ina Z)} y BRLF1 \tout{(denominada
  tambi\'en prote\'ina R)}. \red{Posteriormente se expresan otras 42 proteínas
...
de su fase lítica \red{\cite{Lima2013a}}.

Se estima que EBV se encuentra \red{asociado al} \tout{en el} origen del 2$\%$ de
los cánceres humanos \red{\cite{Parkin2006,Cohen2011,ZurHausen2015}}.
Este oncovirus \red{se encuentra en el origen} a varios tipos de linfomas de linfocitos B y T como
los linfomas de Burkitt o Hodgkin, así como \red{los} carcinomas nasofaríngeo y de
estómago, y sarcomas de músculo liso. También se encuentra asociado a
enfermedades autoinmunes e inflamatorias como mononucleosis infecciosa, síndrome
crónico de EBV y síndrome histiocítico, esclerosis múltiple o lupus eritematoso
sistémico entre otras \red{\cite{Parkin2006,Cohen2011,Young2016,Draborg2013,Niller2008}}. Todo esto convierte al virus EBV en una de las
principales infecciones a controlar en pacientes inmunodeprimidos evidenciando
también la importancia clínica de encontrar moléculas inhibidoras de sus
oncoproteínas preferencialmente en su fase latente.
...
diana del diseño de fármacos \cite{Orlowski1990,Henderson1982}. \red{Además de
  ser la única proteína expresada en cualquier punto del ciclo de vida bifásico
  del virus}, la polivalencia de sus mecanismos moleculares la convierte en la
piedra angular sobre la que descansa la supervivencia de EBV en latencia:
realiza funciones de persistencia, replicación y transcripción del genoma. Para
realizar estas funciones \red{EBNA1} reparte sus 641 aminoácidos en distintos
dominios con distinto rol. \red{Así por ejemplo,} este antígeno nuclear es capaz
de unirse en distintos puntos al episoma vírico en forma de homodímero mediante
su dominio de interacción a ADN, bien para contribuir en su interacción con la
maquinaria proteica del hospedero a su transcripción, bien para hacer de enlace
físico entre el episoma y el material cromosómico de la célula \tout{, as\'i
  como para alterar sus propiedades f\'isicas contribuyendo a su cambio
  topol\'ogico} \red{\cite{Bochkarev1996c}}. Otro dominio cuyo rol es reseñable es el dominio de repetición
de pares de aminoácidos arginina-alanina. Este dominio ha demostrado ser uno de
los responsables de que la célula infectada en fase latente pase desapercibida
frente a linfocitos T citotóxicos CD8 \red{\cite{Lee2004}}. Además, interacciona con proteosomas e
inhibe la proteólisis de dicha proteína \red{\cite{Dantuma2000}}.

Tras EBNA1, otra proteína que destaca por acumular \tout{un enorme}
\red{numerosos} ensayos para determinar la naturaleza de sus funciones es BZLF1
\tout{(tambi\'en conocida como prote\'ina Zta o ZEBRA)}. La proteína BZLF1, cuya
...
en su fase lítica. Este hecho la relaciona de manera \red{reconocida} en la
literatura como el posible agente interruptor \tout{que desencadena} que
desencadena el resto de acontecimientos de la fase lítica
\red{\cite{Petosa2006,Daskalogianni2015,Hartlage2015,Lima2013a}}.
\\

En las últimas d\red{é}cadas \tout{ha habido} \red{se han llevado acabo}
campañas de cribado masivo de moléculas, inicialmente experimentales, en la
b\red{ú}squeda de un antiviral efectivo especialmente para la fase latente
\red{\cite{Henderson1982,Orlowski1990,Li2010a,Li2010b,Lima2013a}}. \tout{De esta manera,}
Aparece en la literatura reciente un no despreciable número \red{de} moléculas
encontradas \emph{de novo} al que se unen aquellos compuestos como antivirales
de alto espectro cuyo efecto ha sido probado en EBV
\red{\cite{Gershburg2005,Li2010a,Clercq2002,Hornig2014}}. Casi todas estas
mol\red{é}culas se reportan con problemas de biodisponibilidad, toxicidad o
ineficiencia. Sobre \red{muchas} de ellas se desconoce \red{su} molécula blanco
y por lo tanto las características del sitio de unión como para poder emprender
proyectos de optimización. El resultado de esta situación es que actualmente no
contamos con moléculas capaces de actuar como antivirales en la fase latente, y
los intentos experimentales de descubrimiento de mol\red{é}culas inhibidoras no
han contribuido a acumular conocimiento sobre los mecanismos de drogabilidad de
las proteínas \red{de EBV} \red{\cite{Gianti2016}}. En cuanto a los intentos de
diseño racional computacional que aparecen en la literatura, \tout{podemos
  concluir que }
\red{estos} están todavía en fase incipiente y no abundan. \tout{Adem\'as,
  extra\~namente} la mayoría de estos intentos reportados hacen uso del diseño
basado en estructura partiendo directamente de la \tout{prote\'ina}
\red{caracterización} obtenida del cristal: obviando \tout{sus} las
modificaciones \tout{en} de su estructura en un proceso de relajación \tout{, o
  yendo un paso m\'as lejos,} \red{o} ignorando cualquier cambio conformacional
\red{que pueda estar en el origen del mecanismo a escala atómica de su función}
\red{\cite{Li2010a,Li2010b,Hornig2014,Gianti2016,Young2016,Messick2017,Jiang2017}}.
S\red{o}lamente un estudio aparece apoyado en la simulación de dinámica
molecular para el diseño de un \red{inhibidor} de EBNA1. Se trata de \tout{en}
un experimento de simulación ``fuerza bruta'' durante un tiempo de 200 ns
\red{\cite{Jiang2017}}, a todas luces insuficiente para determinar la
estabilidad de la unión y la naturaleza de las interacciones atómicas que más
contribuyen entálpica y entrópicamente a la energía libre de unión. Otro
elemento característico y común a los intentos de diseño racional de inhibidores
sobre las proteínas de EBV es el abordaje del filtrado de quimiotecas únicamente
mediante \red{su interacción o docking} de proteína \tout{r\'igida}
\red{\cite{Ferreira2015,Lavecchia2013}}. Estos métodos, lejos de evaluar la
física de todos los grados de libertad del sistema obteniendo magnitudes físicas
relativas a la interacción \tout{que deben ser contrastables con
experimentos reales;}, se apoyan en argumentos heurísticos para la rápida
puntuación de la idoneidad de la interacción. En algunos casos, \red{esta
  puntuación} \tout{el score de los algoritmos} est\red{á}
basada en la evaluación de una energía potencial de interacción de un modelo de
...
cuantitativamente las probabilidades de estancia de un sistema físico \tout{-en
  este caso biomolecular-} en un determinado estado \red{(})en este caso
``acoplados''\red{)} \red{\cite{Shirts2010a,Mortier2015}}. Tampoco de esta
manera se pueden validar sus predicciones dado que no hay magnitudes
físico-químicas termodinámicas -relativas o absolutas- y/o cinéticas de sus
modelos \tout{de biomol\'eculas} que poder comparar con experimentos in vitro
\red{\cite{Chaires2008}}.

\tout{Es notable que} Existe una ausencia importante de estudios te\red{ó}rico
computacionales que aborden, termodinámica y cinéticamente, el conjunto de
interacciones y cambios estructurales a escala atómica que permitan determinar
el potencial que tienen ciertas proteínas \red{de EBV, potenciales blancos para
  su inhibición como EBNA1 o BZLF1,} para ver alguna de sus funciones
\tout{inhibida} \red{interrumpida} o modulada mediante la interacción con
moléculas diseñadas ad-hoc (drogabilidad \red{\cite{Barril2013}}).
...
\red{\cite{Parkin2006,Cohen2011,Young2016,Draborg2013,Niller2008,ZurHausen2015}}.
...
hospedero. Pero su carga viral, \tout{seg\'un su} \red{dependiendo del} estadio
de \red{la} fase latente, puede presentar actividad autoinmune, inflamatoria y
oncogénica. El virus tiene la capacidad de transformar la c\red{é}lula infectada
tornándola inmortal\red{
